...
// const baseURL = 'https://traffic.libsyn.com/theinvestorspodcast/';
...
var TIPFeed = function () {
    ...
    this.aboutAudioURL = baseURL + 'About.mp3';
    rss.Feed.call(this);
};
...
TIPFeed.prototype.cardURL = function () {
    return baseURL + 'SmallCard.jpg';
}
