...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'Scan' : function () { new AudioController(this).scanStart(); },
        ...
        'SessionEndedRequest' : function () {
            // Need to return something, so we do save state which returns just true
            this.emit(':saveState');
        },
        'Unhandled' : function () {
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'AMAZON.ResumeIntent' : function () { new AudioController(this).playStart(); },
        'AMAZON.ShuffleOnIntent' : function () { new AudioController(this).shuffle(); },
        'AMAZON.ShuffleOffIntent' : function () { new AudioController(this).shuffle(); },
        'AMAZON.LoopOnIntent' : function () { new AudioController(this).loop(); },
        'AMAZON.LoopOffIntent' : function () { new AudioController(this).loop(); },
        'AMAZON.RepeatIntent' : function () { new AudioController(this).repeat(); },
    ...
    scanModeIntentHandlers : Alexa.CreateStateHandler(constants.states.SCAN_MODE, {
        ...
        'Play' : function () { new AudioController(this).playReset(); },
        ...
        'AMAZON.StopIntent' : function () { new AudioController(this).stop(); },
        'AMAZON.CancelIntent' : function () { new AudioController(this).stop(); },
        'AMAZON.ResumeIntent' : function () { new AudioController(this).scanResume(); },
        'AMAZON.StartOverIntent' : function () { new AudioController(this).startOver(); },
        'AMAZON.ShuffleOnIntent' : function () { new AudioController(this).shuffle(); },
        'AMAZON.ShuffleOffIntent' : function () { new AudioController(this).shuffle(); },
        'AMAZON.LoopOnIntent' : function () { new AudioController(this).loop(); },
