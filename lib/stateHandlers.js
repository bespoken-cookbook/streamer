...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'Play' : function () {
            ...
            if (this.event.request.intent.slots.feedItem !== undefined) {
                jumpToIndex = this.event.request.intent.slots.feedItem.value;
            }
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'AMAZON.YesIntent' : function () { controller.expansion.call(this) },
...
var controller = function () {
    return {
        ...
        expansion: function () {
            console.log("YES - I HAVE EXPANDED");
        }
    }
}();
