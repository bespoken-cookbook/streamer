    ...
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            AudioManager.introductorySSML(function (ssml) {
                var reprompt = 'You can say About The Podcast, Latest Episode, or Scan';
        ...
        'Play' : function () {
            var feedItem = null;
            if (this.event.request.intent.slots.feedItem !== undefined) {
                feedItem = this.event.request.intent.slots.feedItem.value;
            }
            ...
            if (!this.attributes['playOrder']) {
                ...
                this.attributes['playOrder'] = Array.apply(null, {length: AudioManager.feed().length()}).map(Number.call, Number);
                this.attributes['index'] = 0;
                if (feedItem !== undefined && feedItem !== null) {
                    this.attributes['index'] = parseInt(feedItem);
                }
                this.attributes['offsetInMilliseconds'] = 0;
...
var controller = function () {
    return {
        ...
        scan: function () {
             ...
             *      Next/Previous commands issued.
             */
            this.handler.state = constants.states.SCAN_MODE;
        ...
        reset: function () {
            ...
            var message = AudioManager.introductorySSML(function (ssml) {
                this.response.speak(ssml).listen(reprompt);
                this.emit(':responseReady');
            });
        }
    }
