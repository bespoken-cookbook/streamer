...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'Play' : function () { new AudioController(this).play(); },
        'Scan' : function () {
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (controller.playbackFinished) {
                ...
                var podcast = AudioManager.feed().items(controller.index);
    ...
    remoteControllerHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
         ...
         */
        'PlayCommandIssued' : function () { new AudioController(this).play(); },
...
function isScanning(handlerContext) {
    return handlerContext.handler.state === constants.states.SCAN_MODE;
}

function resetState(handlerContext) {
    handlerContext.handler.state = constants.states.START_MODE;
    handlerContext.response.sessionAttributes['STATE'] = constants.states.START_MODE;
}