        ...
        alexaVerifier(
            ...
            function verificationCallback(err) {
                if (err) {
                    ...
                    context.response.end("Verification Failure: " + err.toString());
                } else {
                    process(event, context)
                }
            }
...
function process (event, context) {
    ...
    // var rssURL = 'http://theinvestorspodcast.libsyn.com/rss';
...
exports.handler = bst.Logless.capture('b5dc9d93-329f-4d4e-8dd1-6743f42ba661', handler);
