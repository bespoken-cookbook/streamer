    ...
    describe('#fromFile', function() {
        it('Correctly parses RSS feed from file', function(done) {
            RSSAdapter.fromFile('test/rssFeed.xml', function (error, feed) {
                ...
                assert.equal(feed.aboutAudioURL, 'https://s3.amazonaws.com/xapp-alexa/About.mp3');
                assert.equal(feed.introductionAudioURL, 'https://s3.amazonaws.com/xapp-alexa/JPKUnitTest-JPKUnitTest-1645-TAKEMETOWALMART-TRAILING.mp3');
